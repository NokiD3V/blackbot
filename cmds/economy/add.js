...
module.exports.run = async (client, message, args) => {
    ...
    .setDescription(`${message.author} выдал **${moneys}${currency}** пользователю ${member_args}!`)
    message.channel.send(embed)
};
module.exports.help = {
  name: "add",
  aliases: ["добавить", "agive", "выдать"],
  desk: "Выдать деньги на сервере",
  usage: "add <@user> [кол-во]",
  cooldown: 1000 * 5,
